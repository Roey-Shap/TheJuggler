draw_custom = function(offset_pos=new Vector2(0, 0), draw_shadow=false) {
	...
	if draw_shadow {
		...
		draw_sprite_ext(sprite_index, image_index, x + offset_pos.x + off.x, y + offset_pos.y + off.y, image_xscale, image_yscale, image_angle, global.c_lcd_shade, global.lcd_alpha_large);
	} else {
